...
box_t box_update(box_t box) {
	...
	case 0:
		...
		break;
	case 1:
		next.cy = box.cy + box.sy;
		next.rx1 = (box.rx1 - box.cx) * cos(radian(box.t)) - (box.ry1 - box.cy) * sin(radian(box.t)) + box.cx;
		next.ry1 = (box.rx1 - box.cx) * sin(radian(box.t)) + (box.ry1 - box.cy) * cos(radian(box.t)) + box.cy;
		next.rx2 = (box.rx2 - box.cx) * cos(radian(box.t)) - (box.ry2 - box.cy) * sin(radian(box.t)) + box.cx;
		next.ry2 = (box.rx2 - box.cx) * sin(radian(box.t)) + (box.ry2- box.cy) * cos(radian(box.t)) + box.cy;
		next.rx3 = (box.rx3 - box.cx) * cos(radian(box.t)) - (box.ry3 - box.cy) * sin(radian(box.t)) + box.cx;
		next.ry3 = (box.rx3 - box.cx) * sin(radian(box.t)) + (box.ry3 - box.cy) * cos(radian(box.t)) + box.cy;
		next.rx4 = (box.rx4 - box.cx) * cos(radian(box.t)) - (box.ry4 - box.cy) * sin(radian(box.t)) + box.cx;
		next.ry4 = (box.rx4 - box.cx) * sin(radian(box.t)) + (box.ry4 - box.cy) * cos(radian(box.t)) + box.cy;
		next.t += box.st;
...
void box_draw() {
	for (box_t box : FLOW) {
		...
		case 1:
			...
			DrawFormatString(0, 40, GetColor(255, 255, 255), "θ: %f", box.t);
			break;
		}
	}
}
...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nCmdShow) {
	...
	FLOW.push_back(box_generate(1, 305.0f, 30.0f, 180.0f));
	while (true) {
